...
/**
 * This class stands for ClaseFechaExamenesAsiNue StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class ClaseFechaExamenesAsiNue extends AbstractStructBase
{
    /**
     * The codexa
    ...
    /**
     * Constructor method for ClaseFechaExamenesAsiNue
     * @uses ClaseFechaExamenesAsiNue::setCodexa()
     * @uses ClaseFechaExamenesAsiNue::setFecha()
     * @uses ClaseFechaExamenesAsiNue::setCodasi()
     * @uses ClaseFechaExamenesAsiNue::setNomasi()
     * @uses ClaseFechaExamenesAsiNue::setIdactiv()
     * @uses ClaseFechaExamenesAsiNue::setCodgrp()
     * @uses ClaseFechaExamenesAsiNue::setCodconv()
     * @uses ClaseFechaExamenesAsiNue::setConv()
     * @uses ClaseFechaExamenesAsiNue::setIdperiodo()
     * @uses ClaseFechaExamenesAsiNue::setObservaciones()
     * @uses ClaseFechaExamenesAsiNue::setFechareal()
     * @uses ClaseFechaExamenesAsiNue::setHoraini()
     * @uses ClaseFechaExamenesAsiNue::setHorafin()
     * @uses ClaseFechaExamenesAsiNue::setDiasemana()
     * @uses ClaseFechaExamenesAsiNue::setAbrdsm()
     * @uses ClaseFechaExamenesAsiNue::setDsm()
     * @uses ClaseFechaExamenesAsiNue::setAula()
     * @uses ClaseFechaExamenesAsiNue::setAulasig()
     * @uses ClaseFechaExamenesAsiNue::setDescaula()
     * @uses ClaseFechaExamenesAsiNue::setCampus()
     * @uses ClaseFechaExamenesAsiNue::setEdificio()
     * @uses ClaseFechaExamenesAsiNue::setOrden()
     * @uses ClaseFechaExamenesAsiNue::setFlgaula()
     * @uses ClaseFechaExamenesAsiNue::setTurno()
     * @uses ClaseFechaExamenesAsiNue::setDuracion()
     * @uses ClaseFechaExamenesAsiNue::setCapacidad_aulas()
     * @uses ClaseFechaExamenesAsiNue::setObserva_ge()
     * @param string $codexa
     * @param string $fecha
     * @param string $codasi
     * @param string $nomasi
     ...
     * Set codexa value
     * @param string $codexa
     * @return \StructType\ClaseFechaExamenesAsiNue
     */
