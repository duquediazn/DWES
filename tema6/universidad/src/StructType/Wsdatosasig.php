...
/**
 * This class stands for wsdatosasig StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class Wsdatosasig extends AbstractStructBase
{
    /**
     * The plengua
    ...
    /**
     * Constructor method for wsdatosasig
     * @uses Wsdatosasig::setPlengua()
     * @uses Wsdatosasig::setPcurso()
     * @uses Wsdatosasig::setPcodasi()
