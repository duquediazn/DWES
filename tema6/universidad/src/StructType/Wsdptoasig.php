...
/**
 * This class stands for wsdptoasig StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class Wsdptoasig extends AbstractStructBase
{
    /**
     * The plengua
    ...
    /**
     * Constructor method for wsdptoasig
     * @uses Wsdptoasig::setPlengua()
     * @uses Wsdptoasig::setPcurso()
     * @uses Wsdptoasig::setPcodasi()
