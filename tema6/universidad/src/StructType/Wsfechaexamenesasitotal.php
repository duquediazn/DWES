...
/**
 * This class stands for wsfechaexamenesasitotal StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class Wsfechaexamenesasitotal extends AbstractStructBase
{
    /**
     * The plengua
    ...
    /**
     * Constructor method for wsfechaexamenesasitotal
     * @uses Wsfechaexamenesasitotal::setPlengua()
     * @uses Wsfechaexamenesasitotal::setPcodest()
     * @uses Wsfechaexamenesasitotal::setPcurso()
     * @uses Wsfechaexamenesasitotal::setPcodasi()
     * @uses Wsfechaexamenesasitotal::setPcodconvoc()
     * @uses Wsfechaexamenesasitotal::setPorden()
     ...
     * Set plengua value
     * @param string $plengua
     * @return \StructType\Wsfechaexamenesasitotal
     */
