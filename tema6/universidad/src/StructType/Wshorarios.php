...
/**
 * This class stands for wshorarios StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class Wshorarios extends AbstractStructBase
{
    /**
     * The plengua
    ...
    /**
     * Constructor method for wshorarios
     * @uses Wshorarios::setPlengua()
     * @uses Wshorarios::setPcurso()
     * @uses Wshorarios::setPcodasi()
     * @uses Wshorarios::setPorden()
     * @param string $plengua
     * @param string $pcurso
     * @param string $pcodasi
     * @param string $porden
     */
    public function __construct(?string $plengua = null, ?string $pcurso = null, ?string $pcodasi = null, ?string $porden = null)
    {
        $this
            ->setPlengua($plengua)
            ->setPcurso($pcurso)
