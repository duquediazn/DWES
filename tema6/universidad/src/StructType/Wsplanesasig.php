...
/**
 * This class stands for wsplanesasig StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class Wsplanesasig extends AbstractStructBase
{
    /**
     * The plengua
    ...
    /**
     * Constructor method for wsplanesasig
     * @uses Wsplanesasig::setPlengua()
     * @uses Wsplanesasig::setPcurso()
     * @uses Wsplanesasig::setPcodasi()
     ...
     * Set plengua value
     * @param string $plengua
     * @return \StructType\Wsplanesasig
     */
