...
/**
 * This class stands for wsplanesdep StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class Wsplanesdep extends AbstractStructBase
{
    /**
     * The plengua
    ...
    /**
     * Constructor method for wsplanesdep
     * @uses Wsplanesdep::setPlengua()
     * @uses Wsplanesdep::setPcurso()
     * @uses Wsplanesdep::setPcoddep()
